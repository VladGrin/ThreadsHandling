...
// Управлением поведения парикмахера во время отсутствия клиентов (сон, пробудка) занимается классы  Haircutter1, PersonProvider1
...
public class Main1 {
    ...
    public static void main(String[] args) {
        ...
        WaitingRoom1 waitingRoom = new WaitingRoom1(n);

        new Thread(new PersonProvider1(waitingRoom, 20)).start();
        new Thread(new Haircutter1(waitingRoom, 20)).start();
    }
}
